          ...
          <div id="page-inner">
            <div class="row">
             ...
             <hr />        
                ...
                <?php
              	$id = $_GET['Id'];
                $choosee="SELECT * FROM tips WHERE Ts_id = '$id'";
				...
				?>
				<form id="" action="update_tips.php" method="post" role="" >
                    ...
                    <textarea class="ckeditor" name="Tips_Content"> <?php echo $rows['Tips_Content']; ?></textarea>
                    </div>
                    <br>
